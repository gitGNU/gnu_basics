...
enum { B6_ASSERT, B6_PRECOND, B6_POSTCOND };

#define b6_assert(condition)	__B6_ASSERT(B6_ASSERT, condition)
#define b6_precond(condition)	__B6_ASSERT(B6_PRECOND, condition)
#define b6_postcond(condition)	__B6_ASSERT(B6_POSTCOND, condition)
